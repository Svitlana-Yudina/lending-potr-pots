...
export const ForWhom: React.FC = () => (
  <section className="forWhom" id="forWhom">
    ...
    <article className="forWhom__article about grid">
      ...
      <div className="grid__item--desktop_8-5 grid__item--tablet_4-3">
        ...
        <p className="about__description">
          Don&apos;t worry if you happen to knock your
          POTR on the floor, unlike a traditional ceramic
          pot it will take the fall in its stride.
        </p>
      </div>
    </article>
    ...
    <div className="forWhom__container">
      <article
        className="
          grid__item--desktop_2-4
          forWhom__article
          forWhom__article--second
          about
          grid"
        >
        <img
        ...
        <div className="grid__item--desktop_2-11 grid__item--tablet_1-3">
          ...
          <p className="about__description">
            We strived to achieve something that
            would look beautiful in your home while
            being incredibly functional and intuitive to use.
          </p>
        </div>
      </article>
      ...
      <article
        className="
          grid__item--desktop_8-5
          forWhom__article
          forWhom__article--third
          about
          grid"
        >
        <img
        ...
        <div className="grid__item--tablet_4-3 grid__item--desktop_3-10">
          ...
          <h2 className="about__title">
            ...
            time to regular water indoor plants
          </h2>
          <p className="about__description">
            Water is drawn up through the cotton
            by the plant using tried and tested wicking technology.
            It&apos;s particularly useful if you
            aren&apos;t able to water them yourself on a regular basis!
          </p>
        </div>
      </article>
    </div>
